...
const { FiLeaf, FiThermometer, FiDroplet, FiZap, FiArrowRight, FiBarChart3, FiHome } = FiIcons;
  ...
  const blueprints = [
    {
      ...
      benefits: ['350% Lead Increase', '$175K Avg Growth', 'Commercial Focus']
    },
    {
      ...
      benefits: ['220% Lead Increase', '$200K Avg Growth', 'Year-Round Revenue']
    },
    {
      ...
      benefits: ['250% Lead Increase', '$180K Avg Growth', 'Emergency Calls']
    },
    {
      ...
      benefits: ['300% More Calls', '$220K Avg Growth', 'Premium Positioning']
    },
    {
      ...
      benefits: ['220% More Leads', '$160K Avg Growth', 'Expert Positioning']
    },
    {
      id: 'home-service-growth-blueprint',
      title: 'Home Service Growth Blueprint',
      description: 'The complete marketing system for contractors. Learn how to build a dominant online presence and generate consistent leads for your business.',
      icon: FiHome,
      color: 'from-indigo-600 to-purple-700',
      benefits: ['280% Lead Increase', '$250K Avg Growth', 'Local SEO Mastery']
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16" >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get complete step-by-step marketing strategies tailored for your industry.
            Each blueprint includes ROI calculators,lead generation tactics,and proven growth strategies.
          </p>
        </motion.div>
          ...
          {blueprints.map((blueprint, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link to={`/${blueprint.id}`} className="w-full bg-primary-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-primary-700 transition-colors flex items-center justify-center space-x-2 group-hover:bg-primary-700" >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center" >
          <div className="bg-primary-600 rounded-2xl p-8 text-white">
            ...
            <Link to="/contact-us" className="bg-white text-primary-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-lg" >
