        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <Link
              ...
              aria-label="Silahub Technologies Home"
            >
              <img
            ...
            <nav className="hidden md:flex items-center space-x-8" role="navigation">
              {navigation.map((item) => (
                <Link
                  ...
                  to={item.href}
                  onClick={handleLinkClick}
                  className={`font-medium transition-colors duration-200 hover:text-primary-600 focus-ring ${
              ...
              <Link
                to="/contact-us"
                onClick={handleLinkClick}
                className="bg-primary-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-primary-700 transition-colors duration-200 focus-ring"
              >
                Get Free Quote
              </Link>
            </nav>
              ...
              <div className="px-4 py-4 space-y-4">
                ...
                {navigation.map((item) => (
                  <Link
                    ...
                    to={item.href}
                    onClick={handleLinkClick}
                    className={`block font-medium transition-colors duration-200 hover:text-primary-600 focus-ring py-2 ${
                      location.pathname === item.href
                        ? 'text-primary-600'
                        : 'text-gray-700'
                    }`}
                ...
                <Link
                  to="/contact-us"
                  onClick={handleLinkClick}
                  className="block bg-primary-600 text-white px-6 py-3 rounded-lg font-semibold text-center hover:bg-primary-700 transition-colors duration-200 focus-ring mt-4"
                >
                  Get Free Quote
                </Link>
              </div>
