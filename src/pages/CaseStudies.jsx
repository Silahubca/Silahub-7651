  ...
  const caseStudies = [
    {
      ...
      testimonial: {
        text: "Silahub completely transformed our online presence. We went from struggling to find customers to being the go-to plumber in Calgary. The results speak for themselves - we're now booking 3-4 weeks in advance!",
        author: "Mike Johnson",
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary-50 to-secondary-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            See how we've helped home service businesses across Calgary achieve remarkable growth 
            through strategic digital marketing. These are real results from real clients.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8">
              Get your free marketing audit and discover how we can help you achieve similar results.
            </p>
            <a
              href="/contact"
