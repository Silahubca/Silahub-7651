  ...
  const contactInfo = [
    {
      icon: FiPhone,
      title: 'Phone',
      details: '825-288-8332',
      description: 'Call us directly for immediate assistance',
      action: 'tel:8252888332'
    },
    {
      icon: FiMail,
      title: 'Email',
      ...
      action: 'mailto:hello@silahub.com'
    },
    {
      icon: FiMapPin,
      title: 'Location',
      details: 'Calgary, Alberta',
      description: 'Serving Calgary, Alberta & USA',
      action: null
    },
    {
      icon: FiClock,
      ...
      description: 'Guaranteed response to all inquiries',
      action: null
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Most clients start seeing increased website traffic within 30 days. For SEO, significant ranking improvements typically occur within 3-6 months. Google Ads can generate leads immediately once campaigns are optimized.'
    },
    {
