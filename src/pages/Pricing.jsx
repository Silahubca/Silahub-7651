    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary-50 to-secondary-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Transparent Pricing for <span className="text-primary-600">Real Results</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            No hidden fees, no long-term contracts. Choose the services that fit your business needs 
            and budget. All plans include transparent reporting and dedicated support.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get all our services in one comprehensive package and save over $2,200 per month
            </p>
          </motion.div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 mb-6">
                      ...
                      <div className="space-y-2">
                        {allInOnePackage.bonuses.map((bonus, index) => (
                          <div key={index} className="flex items-center text-gray-700">
                            <SafeIcon icon={FiStar} className="w-4 h-4 text-yellow-500 mr-3" />
                            {bonus}
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="space-y-2 text-sm">
                        {allInOnePackage.features.slice(6).map((feature, index) => (
                          <div key={index} className="flex items-center text-primary-800">
                            <SafeIcon icon={FiCheck} className="w-4 h-4 text-primary-600 mr-3" />
                            {feature}
                          </div>
                        ))}
                      </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional website development with flexible monthly payment options. 
              No large upfront costs - spread the investment over time.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {websitePlans.map((plan, index) => (
              <motion.div
                ...
                className={`bg-white rounded-2xl shadow-xl p-8 border-2 ${plan.color} relative ${
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-center space-x-2">
                      <span className="text-3xl font-bold text-primary-600">{plan.monthlyFee}</span>
                      <span className="text-gray-600">/month</span>
                    </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose specific services that match your business needs and goals. 
              Each service can be customized to your requirements.
            </p>
          </motion.div>
